defmodule ReasonReactExerciseWeb.ChannelCase do
  @moduledoc """
  ...
  by setting `use ReasonReactExerciseWeb.ChannelCase, async: true`, although
  ...
  using do
    quote do
      ...
      import ReasonReactExerciseWeb.ChannelCase
